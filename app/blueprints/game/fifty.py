...
#
####################################################################
@fifty.route("/fifty/dash", methods=["GET", "POST"])
@login_required
    ...
    if request.method == "POST":
        ...
        if (page == "fifty_page_dash"):
            ...
            if (bttn == "review"):
                ...
                fifty_package_review = game_fifty.get_fifty_package_review(DATABASE_PG, 
                                                                           session["user_id"], 
                ...
                # Create FIFTY_PACKAGE_GAME package
                fifty_package_game = game_fifty.get_fifty_package_game_again(DATABASE_PG, 
                                                                             session["user_id"],
                                                                             request.form.get("loc"))
...
#
####################################################################
@fifty.route("/fifty/game", methods=["GET", "POST"])
@login_required
    ...
    if request.method == "POST":
        ...
        if (page == "fifty_page_game"):
            ...
            if (bttn == "fifty_page_game_new") or (bttn == "fifty_page_game_pause"):
                ...
                fifty_package_results = game_fifty.get_fifty_package_results(DATABASE_PG, 
                                                                             session["user_id"], 
                                                                             fifty_package_game,
                                                                             fifty_game_submit,
                ...
                # Update record
                game_fifty.get_fifty_game_updated(DATABASE_PG, fifty_package_results)

                # Update n2
                session["n2"] = game_fifty.get_fifty_kpi(DATABASE_PG, session["user_id"])
...
#
####################################################################
@fifty.route("/fifty/results", methods=["GET", "POST"])
@login_required
...
#
####################################################################
@fifty.route("/fifty/review", methods=["GET", "POST"])
@login_required
