...
#
####################################################################
@authy.route("/register", methods=["GET", "POST"])
def game__register():
            ...
            if (nav == "no"):
                ...
                # Ensure password was submitted
                    ...
                    if new_password == confirmation:
                        ...
                        results = get_registered(DATABASE_PG, new_username, new_password)
...
#
####################################################################
@authy.route("/login", methods=["GET", "POST"])
def game__login():
        ...
        if (page == "login"):
            ...
            if (nav == "no"):
                ...
                if (bttn == "login"):
                    ...
                    user = get_user_info(DATABASE_PG, request.form.get("username"))
                    ...
                    session["n2"] = game_fifty.get_fifty_kpi(DATABASE_PG, user["id"])
...
#
####################################################################
@authy.route("/logout", methods=["GET", "POST"])
def game__logout():
